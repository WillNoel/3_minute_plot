...
ax1 = subplot(2,1,1);
area(unique_yr,capac_75,'EdgeColor','none','FaceColor',[0.5 0.5 0.5]); hold on
area(unique_yr,capac_25,'EdgeColor','none','FaceColor','w');
plot(unique_yr,capac_md,'k-',...
    unique_yr,capac_mx,'kx',...
    unique_yr,capac_mn,'k*'); hold off
set(ax1,'FontSize',11);
xlim([1998 2019]);
ylim([0 10]);
...
ax2 = subplot(2,1,2);
h1 = area(unique_yr,turbn_75,'EdgeColor','none','FaceColor',[0.5 0.5 0.5]); hold on
area(unique_yr,turbn_25,'EdgeColor','none','FaceColor','w');
h3 = plot(unique_yr,turbn_md,'k-',...
    unique_yr,turbn_mx,'kx',...
    unique_yr,turbn_mn,'k*'); hold off
set(ax2,'FontSize',11);
